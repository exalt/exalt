...
If your building a single page app, try using [@exalt/router](https://www.npmjs.com/package/@exalt/router) for your routing.

---

## Learn How to Develop Apps with Exalt

You can get started learning Exalt by reading the [documentation](https://github.com/exalt/exalt#documentation).
...
Create a new [issue](https://github.com/exalt/exalt/issues) to get started.